...
def draw_bbox(image, bboxes, classes, allowed_classes, show_label=True):
    if classes == "env":
        classes = read_class_names("./data/classes/env.names")
        allowed_classes=list(read_class_names("./data/classes/env.names").values())
    elif classes == "sub":
        classes = read_class_names("./data/classes/custom.names")
        allowed_classes=list(read_class_names("./data/classes/custom.names").values())
    else:
    ...
    for i in range(num_boxes[0]):
        ...
        opcoor.append((class_ind,coor,score))
        ...
        if class_name not in allowed_classes:
            ...
            if show_label:
                ...
                #Display coor for each detection
                #bbox_mess = '%s: %.2f, %d, %d, %d, %d' % (classes[class_ind], score, coor[0], coor[1], coor[2], coor[3])
